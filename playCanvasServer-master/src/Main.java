...
import playCanvasViews.PlayCanvasView;
import playCanvasViews.SketchFabView;
import playCanvasViews.autoView;
import playCanvasViews.bodyDetectView;
import playCanvasViews.brainUI;
import playCanvasViews.faceDetectView;
import playCanvasViews.menuView;
import playCanvasViews.sceneDetectView;
import playCanvasViews.textureStream;
import playCanvasViews.virtualNI;
import playCanvasViews.virtualniStatsView;
import playCanvasViews.voiceDetectView;
...
//		ExampleView exampleDynamicPage = new ExampleView(databaseInterface,fileStoreInterface);
		...
		ThreeJS threeJSPage = new ThreeJS(databaseInterface, fileStoreInterface);
		ChatBot chatBotPage = new ChatBot(databaseInterface, fileStoreInterface);
		...
		{			
			...
			for (int i = 0; i < requestToProcess.size(); i++) 
			{
			    ...
			    }else if(threeJSPage.process(toProcess)) {	
			    }else if(chatBotPage.process(toProcess)) {	
			    }
			    else
			    {
